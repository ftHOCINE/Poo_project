...
/**
* Defines a class to read moves for a Hanoi program.
* It mainly provides the <code>readInput</code> method. This method waits that the user enters a command. This command is a tring that must be a legal move or "quit".
